...
import com.example.firebase_google_signin.databinding.ActivityMainBinding
        ...
        Emitter.Listener { args ->
            runOnUiThread(Runnable {
                ...
                if(data.getBoolean("success")) {
                    startActivity(Intent(applicationContext,AuthOk::class.java))
                }
                else {
